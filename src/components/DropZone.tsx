      ...
      {hasFiles ? (
        <div className="flex-1 flex flex-col">
          <div className="flex-1 bg-blue-50 rounded-lg p-4 mb-4">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                <p className="font-semibold text-slate-800 truncate" title={dirName}>{dirName}</p>
          ...
          <button
            onClick={handlePick}
            disabled={loading}
            className="w-full py-2 px-4 text-sm text-slate-600 border border-slate-200 rounded-lg hover:bg-slate-50 hover:border-slate-300 transition-colors"
          >
        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          <button
            onClick={handlePick}
            disabled={loading}
            className="group w-full border-2 border-dashed border-slate-200 rounded-xl p-8 flex flex-col items-center gap-3 hover:border-blue-400 hover:bg-blue-50 transition-all duration-200 cursor-pointer"
          >
            <div className="w-14 h-14 bg-slate-100 group-hover:bg-blue-100 rounded-full flex items-center justify-center transition-colors">
              {loading ? (
                ...
                <svg className="w-6 h-6 text-slate-400 group-hover:text-blue-500 transition-colors" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-slate-400 mt-1">{t('grantAccess')}</p>
            </div>
          </button>
        </div>
      )}
