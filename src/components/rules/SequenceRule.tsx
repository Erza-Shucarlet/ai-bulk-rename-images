  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-3 gap-2">
        <div>
          <label className="text-xs text-slate-500 dark:text-slate-400 mb-1 block">{t('startNumber')}</label>
          <input
            type="number"
            value={rule.start}
            min={0}
        ...
        <div>
          <label className="text-xs text-slate-500 dark:text-slate-400 mb-1 block">{t('step')}</label>
          <input
            type="number"
            value={rule.step}
            min={1}
        ...
        <div>
          <label className="text-xs text-slate-500 dark:text-slate-400 mb-1 block">{t('minDigits')}</label>
          <input
            type="number"
            value={rule.digits}
            min={1}
      ...
      <div className="grid grid-cols-2 gap-2">
        <div>
          <label className="text-xs text-slate-500 dark:text-slate-400 mb-1 block">{t('separator')}</label>
          <input
            type="text"
        ...
        <div>
          <label className="text-xs text-slate-500 dark:text-slate-400 mb-1 block">{t('position')}</label>
      ...
      <div className="text-xs text-slate-400 dark:text-slate-500 bg-slate-50 dark:bg-slate-700 rounded-lg px-3 py-2">
        {t('example')}&nbsp;
